package ru.fazlyev.linkshortener.beanpostprocessor;
...
public class LogExecutionTimeBeanPostprocessor implements BeanPostProcessor {
    ...
    private final Map<String, ClassMethods> acceptableBean = new HashMap<>();
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Method method : methods) {
            if (method.isAnnotationPresent(LogExecutionTime.class)) {
                acceptableBean.putIfAbsent(beanName, new ClassMethods(bean.getClass(), new ArrayList<>()));
                acceptableBean.get(beanName).getMethods().add(method);
            }
        }
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ClassMethods classMethods = acceptableBean.get(beanName);
        ...
        MethodInterceptor methodInterceptor = (o, method, args, methodProxy) -> {
            ...
            if(isAcceptable) {
                ...
                try {
                    ...
                    stopWatch.stop();
                    log.info("Время выполнения метода '{}': {} мс", method.getName(), stopWatch
                            .getTotalTimeMillis());
                }
            }
            try {
